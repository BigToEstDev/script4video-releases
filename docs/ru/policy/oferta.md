...
Мы обрабатываем персональные данные в соответствии с применимыми законами о защите данных, включая Общий регламент по защите данных (GDPR) Европейского союза, а также аналогичными законами в других юрисдикциях, в пределах которых действуют наши пользователи.  
Контроллером персональных данных является владелец программного обеспечения script4video. По вопросам, связанным с обработкой данных, вы можете связаться через Telegram или Email: support@script4video.org.   
Вы можете запросить удаление своих персональных данных в любой момент. Однако в случаях, когда данные необходимы для учёта лицензий или соблюдения закона, мы можем сохранить их в минимальном необходимом объёме.  
Мы используем только технически необходимые cookie-файлы. Вы можете отключить cookies в настройках браузера.  
